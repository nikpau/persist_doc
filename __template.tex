...
\reportsubtitle{A guide to modeling and assessing inland vessel traffic using the PERSIST framework} % Report subtitle, include new lines if needed

\reportauthors{Niklas Paulig\\Fabian Hart} % Report authors/group/department, include new lines if needed
...
\begin{fullwidth} % Use the whole page width
	...
	\hfill\includegraphics[width=5cm]{tu.pdf} % Company logo
...
\begin{twothirdswidth} % Content in this environment to be at two-thirds of the whole page width
	...
	\textcopyright~[2022] [Technische Universtiät Dresden | Bundesanstalt für Wasserbau] 
